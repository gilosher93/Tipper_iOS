...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func getShifts()->[Shift]?{
        ...
        do{
            shifts = try managedObjectContext.executeFetchRequest(fetchRequest) as! [Shift];
            return shifts!;
        }catch{
    ...
    lazy var applicationDocumentsDirectory: NSURL = {
        // The directory the application uses to store the Core Data store file. This code uses a directory named "example.Tipper_iOS" in the application's documents Application Support directory.
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = NSBundle.mainBundle().URLForResource("Tipper_iOS", withExtension: "momd")!
